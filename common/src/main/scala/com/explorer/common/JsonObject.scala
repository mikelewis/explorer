...
abstract class BaseFetchedJsonObject(message_type: String, original_url: String) extends BaseJsonObject(message_type)
case class JsonCompletedFetch(original_url: String, final_url: String,
  ...
  extends BaseFetchedJsonObject(message_type, original_url)
