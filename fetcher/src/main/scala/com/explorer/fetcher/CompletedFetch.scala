...
case class SucessfulFetch(override val trafficMan: ActorRef, override val originalUrl: String, newUrl: String, status: Int, headers: Map[String, String], body: String)
